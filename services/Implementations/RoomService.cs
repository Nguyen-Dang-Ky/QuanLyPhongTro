...
namespace QuanLyPhongTro.services.Implementations
{
    public class RoomService : IRoomService
    {
        ...
        {
            var phong = await _context.Rooms.FirstOrDefaultAsync(p => p.RoomID == id);
        ...
        public async Task<bool> DeleteRoomAsync (int id)
        {
            ...
            // 2️⃣ Tìm Room + Include BoardingHouse
            var room = await _context.Rooms
                .Include(r => r.BoardingHouse)
            ...
            // 4️⃣ Không cho xóa nếu đang có Contract Active
            ...
            if (hasActiveContract)
                throw new Exception("Cannot delete room with active contract.");

            // 5️⃣ Set trạng thái Inactive thay vì xóa
